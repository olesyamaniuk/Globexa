document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".y-h-navigation-list");
  const headerRef = document.querySelector(".y-h-header");
  const navigationRef = document.querySelector(".y-h-navigation");
  ...
  document.querySelectorAll(".y-h-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".y-h-toggle-button img");
